...
.link_ysf {background-color: #ff7f50; outline:none;}
.link_tan {background-color: #d2b48c; outline:none;}
.link_royalblue {background-color: #4169e1; outline:none;}
.link_especial {background-color:rgb(36, 162, 235); outline:none;}
.link_blanco {background-color:#ffffff; outline:none;}
...
<center>
  ...
  <div>
<?php
    //echo '<div class="button link_blanco" style="font: 10pt arial, sans-serif; color: red; //border-radius:2px;">'."\n";
...
<?php
    echo '<div class="button link_granate" style="font: 8pt arial, sans-serif; border-radius:4px;">'."\n";
    echo '<a href="dvs/brandmeister.php" style="color: white; text-decoration: none;" onmouseover="this.style.color=\'#000\'" onmouseout="this.style.color=\'white\'">ABRIR BM</a>';
?>

</div> 
<?php
    echo '<div class="button link_granate" style="font: 8pt arial, sans-serif; border-radius:4px;">'."\n";
    echo '<a href="dvs/dmrplus.php" style="color: white; text-decoration: none;" onmouseover="this.style.color=\'#000\'" onmouseout="this.style.color=\'white\'">ABRIR DMR+</a>';
?>

</div> 
<?php
    echo '<div class="button link_granate" style="font: 8pt arial, sans-serif; border-radius:4px;">'."\n";
    echo '<a href="dvs/especial.php" style="color: white; text-decoration: none;" onmouseover="this.style.color=\'#000\'" onmouseout="this.style.color=\'white\'">ABRIR ESPECIAL</a>';
?>
...
<?php
    echo '<div class="button link_granate" style="font: 8pt arial, sans-serif; border-radius:4px;">'."\n";
    echo '<a href="dvs/tgif.php" style="color: white; text-decoration: none;" onmouseover="this.style.color=\'#000\'" onmouseout="this.style.color=\'white\'">ABRIR TGIF</a>';
?>

</div> 
<?php
    echo '<div class="button link_granate" style="font: 8pt arial, sans-serif; border-radius:4px;">'."\n";
    echo '<a href="dvs/freedmr.php" style="color: white; text-decoration: none;" onmouseover="this.style.color=\'#000\'" onmouseout="this.style.color=\'white\'">ABRIR FREEDMR</a>';
?>
...
<?php
    echo '<div class="button link_naranja" style="font: 8pt arial, sans-serif; border-radius:4px;">'."\n";
    echo '<a href="dvs/config/sistema_brandmeister.php" style="color: white; text-decoration: none;" onmouseover="this.style.color=\'#000\'" onmouseout="this.style.color=\'white\'">EDITAR BM</a>';
?>

</div> 
<?php
    echo '<div class="button link_naranja" style="font: 8pt arial, sans-serif; border-radius:4px;">'."\n";
    echo '<a href="/dvs/config/sistema_plus.php" style="color: white; text-decoration: none;" onmouseover="this.style.color=\'#000\'" onmouseout="this.style.color=\'white\'">EDITAR DMR+</a>';
?>

</div> 
<?php
    echo '<div class="button link_naranja" style="font: 8pt arial, sans-serif; border-radius:4px;">'."\n";
    echo '<a href="/dvs/config/sistema_especial.php" style="color: white; text-decoration: none;" onmouseover="this.style.color=\'#000\'" onmouseout="this.style.color=\'white\'">EDITAR ESPECIAL</a>';
?>

</div> 
<?php
    echo '<div class="button link_naranja" style="font: 8pt arial, sans-serif; border-radius:4px;">'."\n";
    echo '<a href="/dvs/config/sistema_tgif.php" style="color: white; text-decoration: none;" onmouseover="this.style.color=\'#000\'" onmouseout="this.style.color=\'white\'">EDITAR TGIF</a>';
?>

</div> 
<?php
    echo '<div class="button link_naranja" style="font: 8pt arial, sans-serif; border-radius:4px;">'."\n";
    echo '<a href="/dvs/config/sistema_freedmr.php" style="color: white; text-decoration: none;" onmouseover="this.style.color=\'#000\'" onmouseout="this.style.color=\'white\'">EDITAR FREEDMR</a>';
?>
...
?>
<?php
    echo '<div class="button link_rojo" style="font: 8pt arial, sans-serif; border-radius:4px;">'."\n";
    echo '<a href="dvs/config/editor_general.php" style="color: white; text-decoration: none;" onmouseover="this.style.color=\'#000\'" onmouseout="this.style.color=\'white\'">EDITOR GENERAL</a>';
?>

</div> 
<?php
    echo '<div class="button link_royalblue" style="font: 8pt arial, sans-serif; border-radius:4px;">'."\n";
    echo '<a href="/dvs/config/actualiza_reflectores.php" style="color: white; text-decoration: none;" onmouseover="this.style.color=\'#000\'" onmouseout="this.style.color=\'white\'">ACTUALIZAR REFLECTORES</a>';
?>
</div> 
<?php
    echo '<div class="button link_verde" style="font: 8pt arial, sans-serif; border-radius:4px;">'."\n";
    echo '<a href="/dvs/config/activar_dvswitch.php" style="color: white; text-decoration: none;" onmouseover="this.style.color=\'#000\'" onmouseout="this.style.color=\'white\'">ACTIVAR DVSWITCH</a>';
?>
</div> 
<?php
    echo '<div class="button link_rojo" style="font: 8pt arial, sans-serif; border-radius:4px;">'."\n";
    echo '<a href="/dvs/config/desactivar_dvswitch.php" style="color: white; text-decoration: none;" onmouseover="this.style.color=\'#000\'" onmouseout="this.style.color=\'white\'">DESACTIVAR DVSWITCH</a>';
?>
</fieldset>
