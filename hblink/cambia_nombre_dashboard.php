...
$nombre_dashboard = exec("sed -n '1p' /opt/HBmonitor/config.py");
$nombre_dashboard = substr("$nombre_dashboard", 18, 50);
...
<!--============== CAJA 7 CONFIGURACIONES ==================================================================--> 
    ...
    <h5>CONFIGURA NOMBRE DEL DASHBOARD</h5>

<form method="post" action="cambio_nombre_dashboard_ejecutado.php">
        <input name="dashboard" class="fuente_boton3 form-control" placeholder="Introduce el nombre + Enter"> 
            <div style="background: rgb(15,64,145);" class="fondo_datos">Nombre Dashboard: 
                <span class="color_verde"><?php echo $nombre_dashboard;?></span>
            </div> 
</form>
