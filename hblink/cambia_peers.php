...
<form method="post" action="cambia_peers_ejecutado.php">
        <input name="peers" class="fuente_boton3 form-control" placeholder="Introduce el número + Enter"> 
            <div style="background: rgb(15,64,145);" class="fondo_datos">Número de peers: 
