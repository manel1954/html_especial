...
<html lang="en">
 ...
 <!--  <div class="page-header" style="position:relative;">
  <h1><small>MMDVM-Dashboard by DG9VH -->  
  
<div class="header_negro">
  

<br>

<!-- Añadido 10-06-2023 -->
<div id="Logo" style="position:absolute;top:20px;right:50px;"><a href="##"><img src="<?php echo LOGO ?>" width="200px" style="width:50px hspace="10" vspace="10" align="absmiddle"></a></div>


  <span class="color_orange">&nbsp;&nbsp;&nbsp;DASHBOARD &nbsp;&nbsp;&nbsp;- &nbsp;&nbsp;&nbsp;<?php echo getCallsign($mmdvmconfigs) ?></span>
</div>
</div>
